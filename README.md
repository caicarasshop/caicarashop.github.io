...
<body>
  ...
  <header>
    <h1>AdegaCaiçara</h1>
    <p>Bebidas alcoólicas e não alcoólicas para todos os gostos 🍷🍹</p>
  </header>
    ...
    <section class="container" id="cerveja">
      ...
      <div class="grid">
        ...
        <div class="card" data-id="cerveja-brahma" data-name="BRAHMA" data-price="4.50">
          ...
          <div class="card-content">
            <h3>BRAHMA</h3>
            <p>O sabor clássico que nunca sai de moda.</p>
            <div class="card-bottom">
        ...
        <div class="card" data-id="cerveja-budweiser" data-name="BUDWEISER" data-price="6.00">
          ...
          <div class="card-content">
            <h3>BUDWEISER</h3>
            <p>Leve, com sabor clássico e refrescante.</p>
            <div class="card-bottom">
      ...
      <div class="grid">
        ...
        <div class="card" data-id="vinho-branco" data-name="Vinho Branco Suave" data-price="69.90">
          ...
          <div class="card-content">
            ...
            <p>Equilíbrio entre frescor e doçura.</p>
            <div class="card-bottom">
        ...
        <div class="card" data-id="vinho-rose" data-name="Vinho Rosé Delicado" data-price="79.90">
          <img src="https://lebiscuit.vtexassets.com/arquivos/ids/17511095/17255358461374.jpg?v=638611326489770000" alt="Vinho Rosé">
          <div class="card-content">
            <h3>Vinho Rosé Delicado</h3>
        ...
        <div class="card" data-id="vinho-espumante" data-name="Espumante Brut" data-price="119.90">
          ...
          <div class="card-content">
            ...
            <p>Perfeito para celebrações e momentos especiais.</p>
            <div class="card-bottom">
    ...
    <section class="container" id="refrigerante">
      ...
      <div class="grid">
        <div class="card" data-id="ref-coca" data-name="Coca Cola" data-price="12.00">
          ...
          <div class="card-content">
            <h3>Coca Cola</h3>
            <p>O sabor clássico com gás na medida certa.</p>
            <div class="card-bottom">
        ...
        <div class="card" data-id="ref-guarana" data-name="Guaraná Antarctica" data-price="10.00">
          <img src="https://s3-sa-east-1.amazonaws.com/files-sc.sigecloud.com.br/Producao/34ef3c37-95cf-49f4-bcc8-41bce77d8188/ImagensProdutos/66fc49489015e5c5b5bb8b06_600x600.jpeg" alt="Guaraná Antarctica">
          <div class="card-content">
            <h3>Guaraná Antarctica</h3>
            <p>Ideal para acompanhar qualquer refeição.</p>
            <div class="card-bottom">
        ...
        <div class="card" data-id="ref-pepsi" data-name="PEPSI" data-price="10.00">
          ...
          <div class="card-content">
            <h3>PEPSI</h3>
            <p>Gás suave e sabor marcante.</p>
            <div class="card-bottom">
              <div class="price">R$ 10,00</div>
              <button class="btn-add" type="button">Adicionar</button>
            </div>
        ...
        <div class="card" data-id="ref-it" data-name="IT" data-price="6.00">
          ...
          <div class="card-content">
            <h3>IT</h3>
            <p>Sabor autêntico e energético.</p>
            <div class="card-bottom">
              <div class="price">R$ 6,00</div>
              <button class="btn-add" type="button">Adicionar</button>
            </div>
    ...
    <section class="container" id="gin">
      ...
      <div class="grid">
        <div class="card" data-id="gin-ballena" data-name="Ballena" data-price="130.00">
          ...
          <div class="card-content">
            <h3>Ballena</h3>
            <p>Botânicos equilibrados com toque de de morango.</p>
            <div class="card-bottom">
        ...
        <div class="card" data-id="gin-eternity" data-name="Eternity" data-price="40.00">
          ...
          <div class="card-content">
            <h3>Eternity</h3>
            <p>Um aroma celestial com equilíbrio perfeito entre frescor e elegância</p>
            <div class="card-bottom">
        ...
        <div class="card" data-id="gin-tanqueray" data-name="Tanqueray" data-price="130.00">
          ...
          <div class="card-content">
            <h3>Tanqueray</h3>
            <p>Clássico, refinado e destilado para paladares exigentes</p>
            <div class="card-bottom">
              <div class="price">R$ 130,00</div>
              <button class="btn-add" type="button">Adicionar</button>
            </div>
      ...
      <div class="grid">
        ...
        <div class="card" data-id="whisky-oldparr" data-name="Old Parr 12 Anos" data-price="140.00">
          ...
          <div class="card-content">
            ...
            <p>O equilíbrio perfeito entre tradição e intensidade</p>
            <div class="card-bottom">
        ...
        <div class="card" data-id="whisky-buffalo" data-name="Buffalo Trace Bourbon" data-price="180.00">
          ...
          <div class="card-content">
            ...
            <p>Três vezes destilado, suave e aromático</p>
            <div class="card-bottom">
        ...
        <div class="card" data-id="whisky-jack" data-name="Jack Daniel’s Tennessee Whiskey" data-price="150.00">
          <img src="https://tse3.mm.bing.net/th/id/OIP.FdMx1SCOYstP8QHiv7yQYAHaHa?rs=1&pid=ImgDetMain&o=7&rm=3" alt="Jack Daniel’s">
          <div class="card-content">
  ...
  <aside id="cartSidebar" class="cart-sidebar" aria-hidden="true">
    <div class="cart-header">
      <h3>Seu Carrinho</h3>
      <button id="closeCart" class="cart-close" aria-label="Fechar carrinho">Fechar ✕</button>
    </div>

    <div id="cartItems" class="cart-items" aria-live="polite">
      <!-- itens dinamicamente inseridos aqui -->
      <p id="emptyMsg" style="color:var(--muted); padding: 8px 0;">Seu carrinho está vazio — adicione produtos.</p>
    </div>
  ...
  <footer>
    © 2025 <span>AdegaCaiçara</span> — Todos os direitos reservados.
  </footer>
  ...
  <script>
    ...
    checkoutBtn.addEventListener('click', () => {
      ...
      // Simulação simples: só limpa carrinho e mostra valor
